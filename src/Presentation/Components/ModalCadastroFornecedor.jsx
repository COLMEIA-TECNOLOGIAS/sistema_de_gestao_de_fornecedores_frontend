                ...
                <div className="p-12 text-center">
                    ...
                    <div className="flex justify-center mb-6">
                        <div className="relative">
                            <UserPlus className="w-24 h-24 text-[#44B16F]" strokeWidth={1.5} />
                        </div>
                    </div>
                    ...
                    <div className="flex gap-4 justify-center">
                        ...
                        <button className="px-8 py-3 bg-[#44B16F] text-white rounded-lg hover:bg-[#3a9d5f] transition-colors font-medium">
                            Enviar link externo
                        </button>
                    </div>
                </div>
